...
<section class="book-home" data-book-home="fund-fables" data-start-url="01-证券投资基金概述/01-证券投资基金简介/01-证券投资基金概念/">
  <p class="library-kicker">Securities Investment Funds</p>
  <h1>基金从业 · 科目二</h1>
  <p class="book-home__lead">
    用寓言故事讲解《证券投资基金基础知识》全部章节。你可以直接从这里进入章节，
...
<section class="book-toc" aria-labelledby="fund-fables-toc-title">
  <div class="library-section__heading">
    ...
    <h2 id="fund-fables-toc-title">直接选择章节</h2>
  </div>
  ...
  <div class="book-toc__grid">
    ...
    <a class="book-toc-card" href="02-基金的类型/01-证券投资基金分类概述/01-分类的意义/">
      <span>02</span>
      <strong>基金的类型</strong>
      <small>按募集方式、投资对象、交易模式和产品形态理解基金分类。</small>
    </a>
    <a class="book-toc-card" href="03-投资管理基础/02-财务报表分析/01-财务报表分析简介/">
      <span>03</span>
    ...
    <a class="book-toc-card" href="05-固定收益投资/01-债券与债券市场/01-债券市场概述与分类/">
      <span>05</span>
      <strong>固定收益投资</strong>
      <small>债券市场、收益风险、债券体系、估值、久期与信用利差。</small>
    </a>
    <a class="book-toc-card" href="06-衍生工具/01-衍生工具概述/01-衍生工具的定义/">
      <span>06</span>
      <strong>衍生工具</strong>
      <small>远期、期货、期权、互换和四类合约区别。</small>
    </a>
    <a class="book-toc-card" href="07-另类投资/01-另类投资概述/01-另类投资的概念与主要类别/">
      <span>07</span>
      <strong>另类投资</strong>
