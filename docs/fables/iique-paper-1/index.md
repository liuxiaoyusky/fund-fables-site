...
<section class="book-home" data-book-home="iique-paper-1" data-start-url="01-風險及保險/01-01-01-風險的意義/">
  <p class="library-kicker">IIQE Paper 1</p>
  <h1>保險原理及實務</h1>
  <p class="book-home__lead">
    香港保险业中介人资格考试（IIQE）卷一研习资料手册（VTC 2021 版本）共 7 章 205 节。
    每一节都被改写成 1980 年前后老香港风情的寓言故事：上环干货铺的周老板、
    永乐街的茶餐厅、维多利亚港的船来船往，把抽象的保险概念落进具体的人物、冲突和选择里。
...
<section class="book-toc" aria-labelledby="iique-paper-1-toc-title">
  <div class="library-section__heading">
    <p class="library-kicker">Contents</p>
    <h2 id="iique-paper-1-toc-title">直接选择章节</h2>
  </div>
