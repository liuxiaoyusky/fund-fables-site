...
<div class="version-switcher" data-version-switcher role="tablist" aria-label="选择版本">
  <button class="version-tab version-tab--active" data-version="v2" role="tab" aria-selected="true" type="button">
    <span class="version-tab__name">v2 新版</span>
    <span class="version-tab__meta">196 篇</span>
  </button>
  <button class="version-tab" data-version="v1" role="tab" aria-selected="false" type="button">
    <span class="version-tab__name">v1 原版</span>
    <span class="version-tab__meta">205 篇</span>
  </button>
</div>

<!-- ============ v2 新版（默认） ============ -->
<section class="book-home" data-version-panel="v2" data-book-home="iique-paper-1-v2" data-start-url="../iique-paper-1-v2/01-風險及保險/01-01-01-風險的意義/">
  <p class="library-kicker">IIQE Paper 1 · v2</p>
  <h1>保險原理及實務</h1>
  <p class="book-home__lead">
    香港保险业中介人资格考试（IIQE）卷一研习资料手册（VTC 2021 版本）共 7 章 196 节。
    这是 2026 年重新生成的 v2 版本——每一节改写成 1980 年前后老香港风情的寓言故事：
    上环干货铺的周老板、永乐街的茶餐厅、维多利亚港的船来船往，把抽象的保险概念落进具体的人物、冲突和选择里。
  ...
  <div class="book-home__status" data-role="book-status">共 7 章，196 篇寓言故事。</div>
</section>

<section class="book-toc" data-version-panel="v2" aria-labelledby="iique-v2-toc-title">
  <div class="library-section__heading">
    <p class="library-kicker">Contents</p>
    <h2 id="iique-v2-toc-title">直接选择章节</h2>
  </div>
...
<!-- ============ v1 原版（保留） ============ -->
<section class="book-home" data-version-panel="v1" data-book-home="iique-paper-1" data-start-url="01-風險及保險/01-01-01-風險的意義/" hidden>
  <p class="library-kicker">IIQE Paper 1 · v1</p>
  <h1>保險原理及實務</h1>
  <p class="book-home__lead">
    这是 2025 年最初生成的 v1 版本，共 7 章 205 节，保留作为参考。每一节同样是老香港风情的寓言故事。
    v2 新版在叙事连贯度和细节上做了重写，两个版本的阅读进度各自独立记录。
  </p>
  ...
  <div class="book-home__status" data-role="book-status">共 7 章，205 篇寓言故事。</div>
</section>

<section class="book-toc" data-version-panel="v1" aria-labelledby="iique-v1-toc-title" hidden>
  <div class="library-section__heading">
    <p class="library-kicker">Contents</p>
    <h2 id="iique-v1-toc-title">直接选择章节</h2>
  </div>
